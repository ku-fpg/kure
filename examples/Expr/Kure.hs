...
seqT t1 t2 f = transform $ \ c -> \case
                                     ...
                                     _           -> throwM $ nodeMismatch "not a Seq"
...
assignT t f = transform $ \ c -> \case
                                    ...
                                    _          -> throwM $ nodeMismatch "not an Assign"
...
varT f = contextfreeT $ \case
                           Var v -> return (f v)
                           _     -> throwM $ nodeMismatch "not a Var"
...
litT f = contextfreeT $ \case
                           Lit v -> return (f v)
                           _     -> throwM $ nodeMismatch "not a Lit"
...
addT t1 t2 f = transform $ \ c -> \case
                                     ...
                                     _         -> throwM $ nodeMismatch "not an Add"
...
eseqT t1 t2 f = transform $ \ c -> \case
                                      ...
                                      _          -> throwM $ nodeMismatch "not an ESeq"
