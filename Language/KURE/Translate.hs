...
-- applicable to 'Rewrite' and 'Lens' (though take care in the 'Lens' case).
-- This module also contains instance declarations for the 'Monad' and 'Arrow' type-class families.
